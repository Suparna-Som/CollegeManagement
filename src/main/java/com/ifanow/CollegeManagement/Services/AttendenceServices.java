...
public class AttendenceServices {
    ...
    public int insertAttendence(int sid,String sName,String department,String loginTime,String logoutTime,float attendencePercentage)
    {
        try {
            ...
            PreparedStatement ps = connection.prepareStatement(queries.insertAttendence);
...
//                productmap.put("Supplier_Id",rs.getString(5));
    ...
    public int Delete(int sId)
    {
        ...
        try {
            connection = dbConnection.getconnect();
            Statement stmt = connection.createStatement();
            PreparedStatement ps = connection.prepareStatement(queries.deleteAttendence);
            ps.setInt(1,sId);
    ...
    public int attendenceUpdate(int srNo,String sName,String department,String loginTime,String logoutTime)
    {
        ...
        try {
            connection = dbConnection.getconnect();
            Statement stmt = connection.createStatement();
            PreparedStatement ps = connection.prepareStatement(queries.updateAttendence);
    ...
    public Float attendencePercentage(int sId)
    {
        ...
        try {
            ...
            connection = dbConnection.getconnect();
            Statement stmt = connection.createStatement();
            PreparedStatement ps = connection.prepareStatement(queries.percentageAttendenceQuery);
            ps.setInt(1,sId);
